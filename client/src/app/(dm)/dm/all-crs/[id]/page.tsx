  ...
  return (
    <PageWrapper title={`${cr.crNumber} — Detail`}>
      <div className="space-y-6">
        ...
        <div className="rounded-xl border border-[#E5E5E5] bg-white p-6 shadow-sm">
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            <div>
              ...
              <p className="font-mono font-semibold text-[#2D2D2D]">{cr.crNumber}</p>
            </div>
            <div>
          ...
          <div className="rounded-xl border border-[#E5E5E5] bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              <div>
                ...
                <p className="text-lg font-bold text-[#2D2D2D]">{ia.estimatedHours}h</p>
              </div>
              {ia.timelineImpact && (
                <div>
        ...
        {/* Internal Notes */}
        <div className="rounded-xl border border-[#E5E5E5] bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-base font-semibold text-[#2D2D2D]">
            Internal Notes{' '}
            <span className="text-xs font-normal text-[#5D5B5B]">(DM & SA only)</span>
          </h2>
